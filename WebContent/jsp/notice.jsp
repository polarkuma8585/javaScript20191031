		...
		<div class="contents_size">
			...
			<div>
				<table>
					...
					<!-- 내용이 반복되는 부분 시작 -->
					<tr class="tr" align="center" onclick="location.href='view.jsp'">
						<td width="70">1</td>
						<td style="cursor: pointer" width="300">&nbsp;&nbsp;&nbsp;가을이
							왔네요...</td>
						<td width="150">홍길동</td>
					...
					<tr class="tr" align="center" onclick="location.href='view.jsp'">
						<td width="70">2</td>
						<td style="cursor: pointer" width="300">&nbsp;&nbsp;&nbsp;오늘은
							휴가입니다.</td>
						<td width="150">홍길동</td>
						<td width="150">2019-10-31</td>
						<td width="70">1</td>
					...
					<tr class="tr" align="center" onclick="location.href='view.jsp'">
						<td width="70">3</td>
						<td style="cursor: pointer" width="300">&nbsp;&nbsp;&nbsp;회사
							휴무일 공지</td>
						<td width="150">홍길동</td>
						<td width="150">2019-10-31</td>
						<td width="70">1</td>
